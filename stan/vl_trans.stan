...
functions{
  real calc_log_prob_no_intra(int trans_form, real use_param1, real use_param2, real use_param3, real t, real log10_v){
    if (trans_form == 1){
      ...
      //print(use_param2);
      //print(log10_v);
      //print(-108*t*(1 - pow(inv(use_param1)/(inv(use_param1) + pow(10, log10_v)), use_param2)));
...
transformed parameters{
  ...
  for (idx in period_v_ad_idx){
    ...
    //print(use_param2);
    //print(use_param3);
    //print(log10_v[period_donor_v_idx[idx[1], idx[2]]]);
    //print(calc_log_prob_no_intra(
    //      trans_form,
  ...
  //for (i in 1:P){
  //  if (log_prob_no_intra_transmission[i] > 0){
  //    print("log prob no intra");
  //    print(log_prob_no_intra_transmission[i]);
  //  }
  //}
  log_prob_no_transmission = log_prob_no_intra_transmission + -1*tot_period_t*beta_extra;
  //for (i in 1:P){
  //  if (log_prob_no_transmission[i] > 0){
  //    print("log prob no transmission");
  //    print(i);
  //    print(tot_period_t[i]);
  //    print(log_prob_no_intra_transmission[i]);
  //    print(-1*tot_period_t*beta_extra);
  //  }
  //}
